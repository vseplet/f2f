...
// group — which strips membership of sudo/wheel and so breaks `sudo` (often
// mode 4750 root:sudo, unexecutable by a non-member → "Permission denied") and
// any other group-gated access. When groups is empty we keep the inherited set
