...
// ValidPeerName reports whether name is acceptable as the `name` field
// of any peer-to-peer control packet (currently pair_req/pair_res).
// Printable ASCII except '|', length 1..64 — '|' is the delimiter of
// canonical signed messages, so excluding it keeps those forms
// unambiguous.
